...
export default function ForgotPasswordPage() {
  ...
  const onSubmit = async (data: ForgotPasswordFormValues) => {
    ...
    try {
      ...
      const redirectBase = typeof window !== 'undefined' ? `${window.location.origin}/reset-password` : (process.env.NEXT_PUBLIC_APP_URL ? `${process.env.NEXT_PUBLIC_APP_URL}/reset-password` : undefined);
