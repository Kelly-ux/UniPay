...
// Deprecated: mock data has been replaced by backend integration scaffolding.
// Keeping only utilities consumed elsewhere (if any). Prefer using values from constants and APIs.
...
export const dueStatuses = ['Paid', 'Unpaid', 'Overdue'];
...
export const getStudentDisplayNameFromId = (studentId: string): string => studentId;
